...
const Add = ({token}) => {
  ...
  <form onSubmit={onSubmitHandler}>
    ...
    <div className='w-full mt-3'>
      <p className='mb-3'>Product Desciption</p>
      <textarea onChange={(e)=>setDescription(e.target.value) } value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write content here' required />
    </div>

    <div className='flex mt-3 flex-col sm:flex-row gap-2 w-full sm:gap-8'>
      ...
      <div>
        ...
        <input onChange={(e)=>setPrice(e.target.value) } value={price}  type="Number" placeholder='25' className='w-full max-w-30 px-3 py-2'/>
      </div>
     ...
     <button type='submit' className='w-28 py-3 mt-5 bg-black cursor-pointer text-white'>Add</button>
  </form>
  )
}
